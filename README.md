...
`ssh -i ~/.ssh/udacity_key.rsa â€“p 2200 root@AWS_IP_ADDRESS` <br>
...
- NOTE: After restart the Home page will return a 404, weâ€™ll fix that next by 
...
It should display â€œRunning on http://localhost:5000/â€ or "Running on http://127.0.0.1:5000/". <br>
...
<br> Remove: `engine = create_engine(â€˜sqlite:///androidevents.dbâ€™, echo=True)`
...
and then in a different terminal run `sudo iptables â€“S` and the banned user should 
